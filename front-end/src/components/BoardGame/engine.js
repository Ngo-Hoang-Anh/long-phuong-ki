...
const recommendMoveKi = (startRow, startCol, rotateStr) => {
    if (rotateStr === RotateType.straight) {
        const res = []
        startRow - 2 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 2, col: startCol + 1 }); // right straight
        startRow - 2 >= 0 && startCol - 1 < 9 && res.push({ row: startRow - 2, col: startCol - 1 }); // left straight
        startRow + 2 < 9 && res.push({ row: startRow + 2, col: startCol }) // down center
        startRow + 2 < 9 && startCol - 2 >= 0 && res.push({ row: startRow + 2, col: startCol - 2 }) // down left
        startRow + 2 < 9 && startCol + 2 < 9 && res.push({ row: startRow + 2, col: startCol + 2 }) // down right
        return res;
    }
    if (rotateStr === RotateType.right) {
        const res = [];
        startCol + 2 < 9 && startRow + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 2 }); // right right
        startCol + 2 < 9 && startRow - 1 >= 0 && res.push({ row: startRow - 1, col: startCol + 2 }); // left right
        startCol - 2 >= 0 && res.push({ row: startRow, col: startCol - 2 }) // down center
        startCol - 2 >= 0 && startRow - 2 >= 0 && res.push({ row: startRow - 2, col: startCol - 2 }) // down left
        startCol - 2 >= 0 && startRow + 2 < 9 && res.push({ row: startRow + 2, col: startCol - 2 }) // down right
        return res;
    }
    if (rotateStr === RotateType.down) {
        const res = []
        startRow - 2 >= 0 && res.push({ row: startRow - 2, col: startCol }) //center
        startRow - 2 >= 0 && startCol + 2 < 9 && res.push({ row: startRow - 2, col: startCol + 2 }); // right
        startRow - 2 >= 0 && startCol - 2 >= 0 && res.push({ row: startRow - 2, col: startCol - 2 }); // left
        startRow + 2 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 2, col: startCol - 1 }); // left
        startRow + 2 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 2, col: startCol + 1 }); // right
        return res;
    }
    if (rotateStr === RotateType.left) {
        const res = [];
        startCol - 2 >= 0 && startRow + 1 < 9 && res.push({ row: startRow + 1, col: startCol - 2 }); // right right
        startCol - 2 >= 0 && startRow - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 2 }); // left right
        startCol + 2 < 9 && res.push({ row: startRow, col: startCol + 2 }) // down center
        startCol + 2 < 9 && startRow - 2 >= 0 && res.push({ row: startRow - 2, col: startCol + 2 }) // down left
        startCol + 2 < 9 && startRow + 2 < 9 && res.push({ row: startRow + 2, col: startCol + 2 }) // down right
        return res;
    }
}
const recommendMoveSi = (startRow, startCol, rotateStr) => {
    if (rotateStr === RotateType.straight) {
        ...
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }); // right
        startRow - 1 >= 0 && startCol - 1 < 9 && res.push({ row: startRow - 1, col: startCol - 1 }); // left straight
        startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 }) // down left
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }) // down right
        return res;
    }
    if (rotateStr === RotateType.right) {
        const res = [];
        startCol + 1 < 9 && res.push({ row: startRow, col: startCol + 1 }) // center straight
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }); // right
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }); // left straight
        startRow - 1 >= 0 && startCol - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 1 }) // down left
        startRow + 1 < 9 && startCol - 1 < 9 && res.push({ row: startRow + 1, col: startCol - 1 }) // down right
        return res;
    }
    if (rotateStr === RotateType.down) {
        ...
        startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 }); // right
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }); // left straight
        startRow - 1 >= 0 && startCol - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 1 }) // down left
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }) // down right
        return res;
    }
    if (rotateStr === RotateType.left) {
        const res = [];
        startCol - 1 >= 0 && res.push({ row: startRow, col: startCol - 1 }) // center straight
        startRow - 1 >= 0 && startCol - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 1 }); // right
        startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 }); // left straight
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }) // down left
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }) // down right
        return res;
    }
}
const recommendMoveTuong = (startRow, startCol, rotateStr) => {
    if (rotateStr === RotateType.straight) {
        ...
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 });// center right
        startRow - 1 >= 0 && startCol - 1 < 9 && res.push({ row: startRow - 1, col: startCol - 1 });// center left 
    ...
    if (rotateStr === RotateType.right) {
        ...
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }); //center right
        startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }); //ceneter left
    ...
    if (rotateStr === RotateType.down) {
        ...
        startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 });// center right
        startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }); // center left 
        startCol - 1 >= 0 && res.push({ row: startRow, col: startCol - 1 }) //  right
    ...
    if (rotateStr === RotateType.left) {
        ...
        startRow - 1 >= 0 && startCol - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 1 }); //  center right
        startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 }); // center left  
...
const recommendMoveVuong = (startRow, startCol) => {
    ...
    startRow - 1 >= 0 && startCol - 1 >= 0 && res.push({ row: startRow - 1, col: startCol - 1 }); // center left
    startRow - 1 >= 0 && startCol + 1 < 9 && res.push({ row: startRow - 1, col: startCol + 1 }); // center right
    startRow + 1 < 9 && startCol - 1 >= 0 && res.push({ row: startRow + 1, col: startCol - 1 }); // down left
    startRow + 1 < 9 && startCol + 1 < 9 && res.push({ row: startRow + 1, col: startCol + 1 }); // down left
    return res;
}
const recommendMoveLong = (startRow, startCol, chessboard) => {
    const res = [];
    for (let i = startRow - 1; i >= 0; i--) { // straight
        const element = chessboard[i][startCol];
        if (element?.teamType) {
            res.push({ row: i, col: startCol });
            break;
    ...
    for (let i = startCol - 1; i >= 0; i--) { // left
        const element = chessboard[startRow][i];
        if (element?.teamType) {
            res.push({ row: startRow, col: i });
            break;
    ...
    for (let i = startCol + 1; i < 9; i++) { // right
        const element = chessboard[startRow][i];
        if (element?.teamType) {
            res.push({ row: startRow, col: i });
            break;
    ...
    for (let i = startRow + 1; i < 9; i++) { // down
        const element = chessboard[i][startCol];
        if (element?.teamType) {
            res.push({ row: i, col: startCol });
            break;
...
const recommendMovePhuong = (startRow, startCol, chessboard) => {
    const res = [];
    for (let i = 1; i < 9; i++) {  //straight left
    ...
    for (let i = 1; i < 9; i++) {  //straight right
...
export const recommendMove = (startRow, startCol, objChess, chessboard) => {
    ...
    switch (type) {
        ...
        case ChessType.Xa:
            return recommendMoveXa(startRow, startCol, funcCheckRotate(rotate), chessboard);
        case ChessType.Ki:
...
export const checkMate = (turn, chess) => {
    let vuong;
    chess.forEach(item => {
        if (!vuong) vuong = item.find(chess => chess?.type === 'V' && chess?.teamType === turn);
    });
    if (vuong) {
        let possibleMoves = recommendMoveVuong(vuong.position.row, vuong.position.col).filter(item => {
            if (chess[item.row][item.col] === null || !chess[item.row][item.col].teamType) return true;
        ...
        for (let row = 0; row < lengthChess; row++) {
            ...
            for (let col = 0; col < lengthCols; col++) {
                ...
                if (piece && piece.position && piece.teamType === turn) {
                    recommendMove(piece.position.row, piece.position.col, piece, chess).forEach(item => {
                ...
                if (piece && piece.position && piece.teamType !== turn) {
                    recommendMove(piece.position.row, piece.position.col, piece, chess).forEach(item => {
                        let srtPosition = `${item.row}${item.col}`;
                        if (item.row === vuong.position.row && item.col === vuong.position.col) {
        ...
        let isNotRoute = possibleMoves.filter(item => impossibleMove[`${item.row}${item.col}`] === undefined);
        ...
        if (isNotRoute.length === 0 && isCheckMate.length > 0) {
            ...
            for (let index = 0; index < isCheckMate.length; index++) {
                ...
                if (piece.type === ChessType.Long || piece.type === ChessType.Xa || piece.type === ChessType.Phuong) {
                    const isCanBlock = recommendMove(piece.position.row, piece.position.col, piece, chess)
                        .filter(item => item.row === vuong.position.row || item.col === vuong.position.col)
        ...
        for (let row = 0; row < chess.length; row++) {
            ...
            for (let col = 0; col < cols.length; col++) {
                ...
                if (piece && piece.teamType === turn) {
                    recommendMove(piece.position.row, piece.position.col, piece, chess).forEach(item => impossibleMove.push(item));
                }
            }
        }
        for (let index = 0; index < impossibleMove.length; index++) {
            const coorPossible = impossibleMove[index];
            if (coorPossible.row === vuong.position.row && coorPossible.col === vuong.position.col) {
                return true;
            }
        }
    }
...
export const checkIsSameType = ({ col: endCol, row: endRow, chessboard, piece }) => {
    let lengthBoard = chessboard.length;
    for (let row = 0; row < lengthBoard; row++) {
        const cols = chessboard[row];
        for (let col = 0; col < cols.length; col++) {
            const _piece = cols[col];
            if (_piece?.teamType && _piece.teamType === piece.teamType && _piece.type === piece.type && (_piece.position.row !== piece.position.row || _piece.position.col !== piece.position.col)) {
                let obj = recommendMove(_piece.position.row, _piece.position.col, _piece, chessboard).find(item => item.col === endCol && item.row === endRow);
                if (obj) {
                    return true;
                }
            }
...
export const isValidMove = (endRow, endCol, objChess, validMove) => {
    return validMove.findIndex(({ row, col }) => row === endRow && col === endCol) !== -1 ? true : false;
}